...
begin
  inherited;
     ...
     //以下两句用语初次给数据库加密码
     //self.Open;
     //rekey(TXMLConfig.GetPWD);
     password := TXMLConfig.GetPWD;
end;
...
function TMailBoxConfigDatabase.Read_<T>(sql: String; params: TObjectList<TKeyValue>): TObjectList<T>;
var
  stmt: TDISQLite3Statement;
  pair: TKeyValue;
  rctx: TRTTIContext;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        stmt.bind_Str16(15, MBCR.PhoneNum);
        stmt.bind_Str16(16, MBCR.UpdateMail);
