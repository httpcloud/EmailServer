...
uses
  ...
  VirtualTrees,
  DIFileCache, DISQLite3_Encryption_DB,DISQLite3Database,  SysUtils,StrUtils;

type
  TMailDB = class(TObject)
    Panel1: TPanel;
    Panel2: TPanel;
    Splitter1: TSplitter;
...
procedure TMailDB.FormCreate(Sender: TObject);
var
  Password: String;
begin
...
procedure TMailDB.FormDestroy(Sender: TObject);
begin
  FDb.Free;
  FHexCache.Free;
end;
...
procedure TMailDB.ChangePassword(const ANewPassword: AnsiString);
begin
...
procedure TMailDB.RefreshHexView;
var
  s: TStream;
begin
  FHexCache.Invalidate;
...
procedure TMailDB.ReloadDatabase;
var
...
procedure TMailDB.btnAddRandomClick(Sender: TObject);
var
  i: Integer;
  NodeData: PNodeData;
begin
...
procedure TMailDB.btnNewClick(Sender: TObject);
var
  Node: PVirtualNode;
  NodeData: PNodeData;
  NewRowID: Int64;
...
procedure TMailDB.btnEditClick(Sender: TObject);
var
  Node: PVirtualNode;
begin
...
procedure TMailDB.btnDeleteClick(Sender: TObject);
var
  Node: PVirtualNode;
  NodeData: PNodeData;
begin
...
procedure TMailDB.btnChangePasswordClick(Sender: TObject);
var
  Password: AnsiString;
begin
...
procedure TMailDB.btnRemovePasswordClick(Sender: TObject);
begin
  ChangePassword('');
end;
...
procedure TMailDB.vtCitiesGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
var
  CityRec: PCityRec;
  NodeData: PNodeData;
begin
...
procedure TMailDB.vtCitiesNewText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; NewText: WideString);
var
  NodeData: PNodeData;
  Stmt: TDISQLite3Statement;
  ColName: WideString;
...
procedure TMailDB.vtCitiesCompareNodes(Sender: TBaseVirtualTree; Node1, Node2: PVirtualNode; Column: TColumnIndex; var Result: Integer);
var
  NodeData: PNodeData;
...
procedure TMailDB.vtHexGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
var
  Block: PDIFileBlock;
begin
