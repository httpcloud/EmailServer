...
type
  ...
  public
   ...
   // function Delete(MBCR: TMailBoxConfigRec; KeyFieldName: string): Int64;overload;
    function Delete(sql: string; params: TObjectList<TKeyValue>): Int64; overload;

    function Add(sql: String; params: TList < TPair < String, TValue >> )  : Int64; overload;
    function Add_for_test(sql: String; params: TObjectList<TKeyValue>): Int64; overload;
    ...
    function Read_<T: class>(sql: String; params: TObjectList<TKeyValue>) : TObjectList<T>; overload;



    function Add(sql: String; params: TDictionary<String, TValue>): Int64;overload;
...
begin
  ...
  // if not Assigned(Result) then
  begin
    stmt := Prepare16('SELECT * FROM MailBoxConfig WHERE MailDomain=? order by updatetime desc;');
    try
