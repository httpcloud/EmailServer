...
type
  ...
  public
    ...
    //add by lwgboy,ｽｫSessionIDｱ｣ｴ贇ﾚURLﾖﾐ｣ｬﾒﾔﾊﾊﾓｦｲｻﾖｧｳﾖCookieｵﾄ莟ﾀﾀﾆ｣
    function GetSessionID2URL(AID: TSessionID): string;
    procedure SetSessionID2URL(AID: TSessionID; AValue: string);
  end;
...
//add by lwgboy,ｽｫSessionIDｱ｣ｴ贇ﾚURLﾖﾐ｣ｬﾒﾔﾊﾊﾓｦｲｻﾖｧｳﾖCookieｵﾄ莟ﾀﾀﾆ｣
function TSessions.GetSessionID2URL(AID: TSessionID): string;
var
  Item: TSessionItem;
begin
  ReadLock;
...
//add by lwgboy,ｽｫSessionIDｱ｣ｴ贇ﾚURLﾖﾐ｣ｬﾒﾔﾊﾊﾓｦｲｻﾖｧｳﾖCookieｵﾄ莟ﾀﾀﾆ｣
procedure TSessions.SetSessionID2URL(AID: TSessionID; AValue: string);
var
  Item: TSessionItem;
begin
  WriteLock;
