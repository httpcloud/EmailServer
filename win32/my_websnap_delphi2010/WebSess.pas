...
type
  ...
  public
    ...
    //add by lwgboy,ｽｫSessionIDｱ｣ｴ贇ﾚURLﾖﾐ｣ｬﾒﾔﾊﾊﾓｦｲｻﾖｧｳﾖCookieｵﾄ莟ﾀﾀﾆ｣
    property SessionID2URL:string read FSessionID2URL write FSessionID2URL;
  end;
  ...
  protected
    ...
    //add by lwgboy,ｽｫSessionIDｱ｣ｴ贇ﾚURLﾖﾐ｣ｬﾒﾔﾊﾊﾓｦｲｻﾖｧｳﾖCookieｵﾄ莟ﾀﾀﾆ｣
    function GetSessionID2URL: string;
    procedure SetSessionID2URL(const AValue: string);
...
//add by lwgboy,ｽｫSessionIDｱ｣ｴ贇ﾚURLﾖﾐ｣ｬﾒﾔﾊﾊﾓｦｲｻﾖｧｳﾖCookieｵﾄ莟ﾀﾀﾆ｣
function TWebSessionImpl.GetSessionID2URL: string;
begin
  Result := Sessions.GetSessionID2URL(FID);
end;
...
//add by lwgboy,ｽｫSessionIDｱ｣ｴ贇ﾚURLﾖﾐ｣ｬﾒﾔﾊﾊﾓｦｲｻﾖｧｳﾖCookieｵﾄ莟ﾀﾀﾆ｣
procedure TWebSessionImpl.SetSessionID2URL(const AValue: string);
begin
  Sessions.SetSessionID2URL(FID, Avalue);
end;
