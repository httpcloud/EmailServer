...
type
  ...
  { TODO -oJMT -cMUSTFIX : This interface is never used. }
  ...
  { TODO -oJMT -cMUSTFIX : This interface is not implemented }
  ...
  protected
    ...
    function GetEchoActionFieldValues: Boolean;
    { TODO -oJMT -cMUSTFIX : This comment is not correct.  ISetSubComponents is not implemented. }
    { ISetSubComponents }
    ...
    procedure NotifyAdapterChange;
    { TODO -oJMT -cMUSTFIX : NotifyList doesn't need to be protected? }
  ...
  public
    ...
    { TODO -oJMT -cMUSTFIX : This doesn't do anything? }
    property ReadOnly;
  end;
  ...
  protected
    ...
    { TODO -oJMT -cMUSTFIX : Does not need to be protected.  Use PageSize property. }
  ...
  { TODO -oJMT -cMUSTFIX : TAdapterUserNameField and TAdapterPassword field don't implement GetDefaultFieldName.  Should they? }
  ...
  public
    ...
    { TODO -oJMT -cMUSTFIX : ItemCount should be protected }
    property ItemCount: Integer read GetItemCount;
    { TODO -oJMT -cMUSTFIX : ItemIndex should be protected }
 ...
 protected
  ...
  protected
    procedure ImplExecuteActionRequest(AActionRequest: IActionRequest; AActionResponse: IActionResponse); override;
    procedure ImplGetAdapterItemRequestParams(var AIdentifier: string; Params: IAdapterItemRequestParams); override;
    { TODO -oJMT -cMUSTFIX : Why is this virtual?  Adapter.nextpage is used most of the time }
  ...
  private
    { TODO -oJMT -cMUSTFIX : Is FIteratorIndex used? }
    FIteratorIndex: Integer;
    FField: TObject;
  protected
  ...
  protected
    ...
    { IAsFormatted }
    function ImplAsFormatted: string; override;
    { TODO -oJMT -cMUSTFIX : Field should be TComponent so that Supports uses QueryInterface }
  ...
  published
    { TODO -oJMT -cMUSTFIX : Nextpage should be published? }
    property Data;
    property Actions;
  ...
  { TODO -oJMT -cMUSTFIX : Not named correctly.  Should be TCustomApplicationAdapterField }
...
begin
  { TODO -oJMT -cMUSTFIX : This function is not needed.  Can just call inherited. }
  if FFieldName = '' then
...
begin
{ TODO -oJMT -cMUSTFIX : This is a little strange.  This function returns FDisplayWidth.  The Ancestor returns -1 }
...
begin
  { TODO -oJMT -cMUSTFIX : Need to implement this method for multivalue fields }
  Result := 1;
end;
...
begin
  { TODO -oJMT -cMUSTFIX : Can call TCustomAdapter.CreateRequestContext directly.
    TCustomAdapter always implements ICreateActionRequestContext }
...
begin
  { TODO -oJMT -cMUSTFIX : DispatchParams is not used. }
...
begin
{ TODO -oJMT -cMUSTFIX : Can hard code htmlvmInput here are not call GetViewModeType }
  Result := AdapterDisplayViewModeTypeNames[GetViewModeType(AAdapterMode)]
end;

{ TODO -oJMT -cMUSTFIX : This function isn't necessary.  Actions don't support view modes. }
...
begin
  { TODO -oJMT -cMUSTFIX : This may not work properly because of the way that Enumerators are release by JScript }
  FIteratorIndex := 0;
  FInIterator := False;
end;
...
begin
  { TODO -oJMT -cMUSTFIX : This method is not needed }
...
begin
  { TODO -oJMT -cMUSTFIX : This method is not necessary }
...
{ TODO -oJMT -cMUSTFIX : Add OnGetNextPage event handler }
...
{ TODO -oJMT -cMUSTFIX :
Should call method in adapter then we could always use the same action but
switch behavior by changing the adpater }
      ...
      try
        ...
        if NextPage <> '' then
          ...
          begin
            ...
            { TODO -oJMT -cMUSTFIX : Don't need to set RedirectOptions here }
            { DONE -oJMT -cUpdate : Fix problems with NextPage 115975  = corbin note: should be fixed}
            // RedirectOptions := roRedirect;
          end;
      except
        on E: Exception do
...
var
  ...
  Intf: IWebGetFieldValue;
begin
  { TODO -oJMT -cMUSTFIX : Should get value from adapter.  Login field should call adapter back. }
  // Delegate to action
  Result := False;
...
procedure TEndUserAdapterLoginFormAction.ImplExecuteActionRequest(
  AActionRequest: IActionRequest; AActionResponse: IActionResponse);
begin
  { TODO -oJMT -cMUSTFIX : Setting redirect options is probably unneccessary. }
  RedirectOptions := [];
  if (Adapter <> nil) then
    with Adapter do
    begin
...
begin
  { TODO -oJMT -cMUSTFIX : No actions.  Call inherited. }
...
var
  ...
  Intf: IWebGetFieldValue;
begin
  { TODO -oJMT -cMUSTFIX : Should just return the title property.  The field usually calls the adapter. }
...
function TCustomStringsValuesList.ImplStartIterator(
  var OwnerData: Pointer): Boolean;
begin
  { TODO -oJMT -cMUSTFIX : Does not set FInIterator }
  FIndex := 0;
  Result := FIndex < Strings.Count;
end;
...
var
  Value: IActionFieldValue;
begin
{ TODO -oJMT -cMUSTFIX : Need to check view access here? }
  if EchoActionFieldValue then
  begin
    Value := ActionValue;
    if Value <> nil then
...
var
  ...
  I: Integer;
begin
  { TODO -oJMT -cMUSTFIX : Are we consistently checking ViewAccess }
  CheckViewAccess;
...
begin
  ...
  begin
    { TODO -oJMT -cMUSTFIX : Shouldn't AHandled be set to True? }
    AHandled := False;
    S := TStringList.Create;
    try
      with AValue do
...
function TCustomAdapterImageField.ImplCheckValueChange(
  AActionRequest: IActionRequest; AFieldIndex: Integer): Boolean;
begin
  { TODO -oJMT -cMUSTFIX : Is it necessary to check the required flag here. }
  with GetActionFieldValues(AActionRequest) do
...
{ TODO -oJMT -cMUSTFIX : This method is deprecated }
...
begin
  { TODO -oJMT -cMUSTFIX : How is this accessed with server-side script using the Values property of the adapter field? }
  Result := '';
...
function TCustomAdapterBooleanField.ImplIsEqual(
  const AValue: Variant): Boolean;
begin
  { TODO -oJMT -cMUSTFIX : This function may not be necessary }
...
{ TODO -oJMT -cMUSTFIX : This method is not necessary.  ListPagedAdapterActions is called by
  ImplGetActionsList }
...
{ TODO -oJMT -cMUSTFIX : This method is not necessary.  Only need to implement ImplGetActionsList. }
...
function TDefaultFieldsPagedAdapter.ImplNextIteration(
  var OwnerData: Pointer): Boolean;
begin
  { TODO -oJMT -cMUSTFIX : Remove this comment }
  // Ancestor should implement
  { TODO -oJMT -cMUSTFIX : Don't need to check record count here }
...
procedure TCustomAdapterGotoPageAction.ImplGetAdapterItemRequestParams(
  var AIdentifier: string; Params: IAdapterItemRequestParams);
begin
  { TODO -oJMT -cMUSTFIX : Should call Adapter.EncodeActionParams? }
